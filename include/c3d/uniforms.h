...
//! Maximum count of floating-point uniforms.
#define C3D_FVUNIF_COUNT 96
//! Maximum count of integer uniforms.
#define C3D_IVUNIF_COUNT 4
//! Maximum count of boolean uniforms.
#define C3D_BUNIF_COUNT 16
...
* @param[in] id ID of the uniform (retrivable using ctrulib's shaderInstanceGetUniformLocation)
* @param[in] size Amount of uniform registers allocated with this pointer.
